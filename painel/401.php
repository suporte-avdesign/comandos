...
<body class="clearfix">
	...
	<div id="container">
		<div class="scratch-metal">
			<h1>401</h1>
            <h3><?php echo $pag; ?></h3>
			<h2>IP: <?php echo $_SERVER['REMOTE_ADDR']?> <br>Não Autorizado</h2>
		</div>
		<button class="button huge anthracite-gradient glossy full-width" id="button" onclick="window.history.back();">Voltar</button>
	</div>
