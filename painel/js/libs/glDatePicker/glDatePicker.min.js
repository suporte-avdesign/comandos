...
s+="<td class='gldp-days "+f+" **-"+f+"'><div class='"+f+"'>"+p+"</div></td>"}e+="<tr class='days'>"+s+"</tr>"}g=k<r||b.allowOld;k=w<d||d<k;b.showPrevNext||(g=k=!1);d="Janeiro Fevereiro Mar&ccedil;o Abril Maio Junho Julho Agosto Setembro Outubro Novembro Dezembro".split(" ")[h.getMonth()]+"&nbsp;"+h.getFullYear();k=("<div class='**'><table><tr>"+("<td class='**-prevnext prev'>"+(g?"\u25c4":"")+"</td>")+"<td class='**-monyear' colspan='5'>{MY}</td>"+("<td class='**-prevnext next'>"+(k?"\u25ba":"")+"</td>")+
"</tr><tr class='**-dow'><td>Seg</td><td>Ter</td><td>Qua</td><td>Qui</td><td>Sex</td><td>Sab</td><td>Dom</td></tr>"+e+"</table></div>").replace(/\*{2}/gi,"gldp-"+b.cssName).replace(/\{MY\}/gi,d);d=c("#"+j);0==d.length&&(d=c("<div id='"+j+"'></div>").appendTo(document.body).css({position:b.position,"z-index":a.closest(".modal").length?999600:100}));d.html(k).css({left:a.offset().left,top:a.offset().top+a.outerHeight()}).slideDown(200);a.addClass("_gldp");c("[class*=-prevnext]",d).click(function(b){b.stopPropagation();
